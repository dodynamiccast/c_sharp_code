...
namespace WindowsFormsApplication1
{
    public partial class UserControl_upload_ex : UserControl
    {
        ...
        private VodUploadTool.VodUpload m_upload;
        ...
        {
            InitializeComponent();
            m_upload = new VodUploadTool.VodUpload();
        }
        ...
        public int SetFileInfo(string strFilePath, string strFileName, string strFileType, int iClassId, long createTime)
        {
            if (m_upload.SetFileInfo(strFilePath, strFileName, strFileType, iClassId) < 0)
                return -1;
        ...
        public void Upload()
        {
            ThreadStart threadStart = new ThreadStart(m_upload.UploadEx);
